...
RISK_CONFIGS = {
    'top25': dict(npz=os.path.join(RES, 'transitions_9state_sex_risk_BACKUP_top25pct.npz')),
    'top10': dict(npz=os.path.join(RES, 'transitions_9state_sex_risk.npz')),
}
...
def main():
    rows = []
    out_path = os.path.join(RES, 'lambda_sweep_fine.json')
